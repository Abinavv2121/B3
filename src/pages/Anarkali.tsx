...
const Anarkali = () => {
  ...
  const filters = [
    { id: "all", name: "All Anarkalis", count: 0 },
    { id: "Floor", name: "Floor Length", count: 0 },
    { id: "Short", name: "Short Anarkalis", count: 0 },
    { id: "Designer", name: "Designer Anarkalis", count: 0 },
    { id: "Bridal", name: "Bridal Anarkalis", count: 0 },
    { id: "Party", name: "Party Wear", count: 0 },
    { id: "Casual", name: "Casual Anarkalis", count: 0 }
  ];
  ...
  const loadProducts = async () => {
    setIsLoading(true);
    try {
      const { data, error } = await supabaseUtils.getProductsBySection('anarkali');
      if (error) {
          ...
          <div className="w-full px-4 lg:px-8 relative z-10">
            ...
            <div className="text-center mb-12 max-w-4xl mx-auto">
              <h2 className="text-3xl lg:text-4xl font-['Italiana'] tracking-wide" 
                ...
                Discover Our <span style={{ color: '#D4AF37' }}>Anarkali Collection</span>
              </h2>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-20">
                <p className="text-white/70 text-lg">No anarkalis found in this category.</p>
              </div>
            )}
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-6xl mx-auto">
                  <div className="space-y-4 group">
                    ...
                    <div className="text-sm font-light tracking-wide" style={{ color: '#C8C8C5' }}>
                      Inspired by the grandeur of Mughal era, our anarkalis embody timeless royal elegance
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 group">
                    ...
                    <div className="text-sm font-light tracking-wide" style={{ color: '#C8C8C5' }}>
                      Crafted from the finest silk, georgette, and crepe fabrics for ultimate comfort and style
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 group">
                    ...
                    <div className="text-sm font-light tracking-wide" style={{ color: '#C8C8C5' }}>
                      Hand-embroidered with zari, sequins, and stone work for a luxurious finish
                    </div>
                  </div>
                </div>
              </div>
