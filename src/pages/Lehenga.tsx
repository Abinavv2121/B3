...
const Lehenga = () => {
  ...
  const filters = [
    { id: "all", name: "All Lehengas", count: 0 },
    { id: "Bridal", name: "Bridal Lehengas", count: 0 },
    { id: "Party", name: "Party Lehengas", count: 0 },
    { id: "Designer", name: "Designer Lehengas", count: 0 },
    { id: "Festival", name: "Festival Lehengas", count: 0 },
    { id: "Casual", name: "Casual Lehengas", count: 0 }
  ];
  ...
  const loadProducts = async () => {
    setIsLoading(true);
    try {
      const { data, error } = await supabaseUtils.getProductsBySection('lehenga');
      if (error) {
          ...
          <div className="w-full px-4 lg:px-8 relative z-10">
            ...
            <div className="text-center mb-12 max-w-4xl mx-auto">
              <h2 className="text-3xl lg:text-4xl font-['Italiana'] tracking-wide" 
                ...
                Discover Our <span style={{ color: '#D4AF37' }}>Lehenga Collection</span>
              </h2>
              <p className="mt-4 text-white/70 text-lg max-w-2xl mx-auto">
                Stunning lehengas for celebrations and special moments, crafted with intricate embroidery 
                and premium fabrics that make every occasion memorable.
              </p>
            </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-20">
                <p className="text-white/70 text-lg">No lehengas found in this category.</p>
              </div>
            )}
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-6xl mx-auto">
                  <div className="space-y-4 group">
                    ...
                    <div className="text-sm font-light tracking-wide" style={{ color: '#C8C8C5' }}>
                      Handcrafted with zari, sequins, and stone work for a luxurious finish
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 group">
                    ...
                    <div className="text-sm font-light tracking-wide" style={{ color: '#C8C8C5' }}>
                      Inspired by the grandeur of Indian royal traditions and celebrations
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 group">
                    ...
                    <div className="text-sm font-light tracking-wide" style={{ color: '#C8C8C5' }}>
                      Crafted from the finest silk, velvet, and brocade for ultimate elegance
                    </div>
                  </div>
                </div>
              </div>
